...
//   constructor(private connectionSocketIO: ConnectionSocketIoService, private profileService: ProfileService, private gameInvitationSocketIO: GameInvitationSocketIoService,
//     private friendsSocketIO: FriendsSocketIoService, private gameInvitationService: GameInvitationService) {}
...
//       this.inviteSent[friend._id] = true;
//     },
//     (error) => {
